...
import com.example.assignment.ChiTietAnh.CTGaiActivity;
...
public class GaiXinhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gai_xinh);
    ...
    private void GetData() {
        ...
        RequestQueue requestQueue =
                Volley.newRequestQueue(GaiXinhActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                imageViewAdapter = new ImageViewAdapter(getApplication(), (ArrayList<Photo>) photos,
                        new ImageViewAdapter.AdapterListener() {
                            ...
                            public void OnClick(int position) {
                                Intent intent = new Intent(GaiXinhActivity.this, CTGaiActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(GaiXinhActivity.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
