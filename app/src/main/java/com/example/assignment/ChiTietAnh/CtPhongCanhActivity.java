...
public class CtPhongCanhActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(CtPhongCanhActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(CtPhongCanhActivity.this, "", Toast.LENGTH_SHORT).show();
                    requestPermissions(new String[]{
                            Manifest.permission.WRITE_EXTERNAL_STORAGE
                    }, PERMISSION_REQUEST_CODE);
                    return;
                } else {
                    dialog = new SpotsDialog.Builder().setContext(CtPhongCanhActivity.this).build();
                    dialog.show();
            ...
            public void onClick(View view) {
                shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
                    ...
                    public void onSuccess(Sharer.Result result) {
                        Toast.makeText(CtPhongCanhActivity.this,"Share sucessfull", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancel() {
                        Toast.makeText(CtPhongCanhActivity.this,"Share cancel", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onError(FacebookException error) {
                        Toast.makeText(CtPhongCanhActivity.this,error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                Picasso.with(getBaseContext())
                        .load(photos.get(viewPager.getCurrentItem()).getUrlL())
    ...
    private void getData() {
        ...
        final ProgressDialog loading = new ProgressDialog(CtPhongCanhActivity.this);
        loading.setMessage("Loading...");
        loading.show();
        //RequestQueue: nơi giữ các request trước khi gửi
        //tạo một RequestQueue bằng lệnh
        RequestQueue requestQueue =
                Volley.newRequestQueue(CtPhongCanhActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                viewpagerAdapter = new ViewpagerAdapter(CtPhongCanhActivity.this, photos); // gắn dữ liệu vào adapter
            ...
            public void onErrorResponse(VolleyError error) {
                loading.dismiss();
                Toast.makeText(CtPhongCanhActivity.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
